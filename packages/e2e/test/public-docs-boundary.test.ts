...
describe("public documentation boundary", () => {
  ...
  it.each([
    ...
    ["IPv4 link-local address", "connect to 169.254.169.254"],
    ...
    ["percent-encoded IPv4 link-local host", "open https://169%2e254%2e169%2e254/path"],
    ["hexadecimal private host", "open http://0xc0.0xa8.0x1.0x1/path"],
    ["hexadecimal IPv4 link-local host", "open http://0xa9.0xfe.0xa9.0xfe/path"],
    ...
    ["integer IPv4 link-local host", "open http://2852039166/path"],
