...
Env:
  ...
  GENIE_KITS_ROOT            Directory where get_kit reads UI kit roots

This scaffold build boots, speaks MCP, and registers ping plus M1 kit lookup and project creation.`;
