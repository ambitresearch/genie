...
immutable, mismatched, or non-`main` inputs; never runs `npm publish`; and never uploads or
replaces release assets. It rebuilds and signs both registry images from the exact server tag,
