...
if ! gh repo view "$REPO" >/dev/null 2>&1; then
  ...
  err "    gh repo create $REPO --private --description 'Harness-agnostic MCP server inspired by Claude Design — AI UI-component generator'"
  exit 1
fi
...
LABELS=(
  ...
  "area:llm|5319e7|LLM endpoint integration (any OpenAI-compatible gateway)"
