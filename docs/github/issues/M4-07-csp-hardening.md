...
**Primary mock:** [`03-embedded-modes.svg`](https://github.com/roshangautam/genie/blob/main/docs/design/03-embedded-modes.svg) — hardened payload renders identically (G-5 byte-identical).
