...
**Primary mock:** [`03-embedded-modes.svg`](https://github.com/ambitresearch/genie/blob/main/docs/designs/design-6/03-embedded-modes.svg) — hardened payload renders identically (G-5 byte-identical).
