...
- [ ] AC7 — Exits non-zero if `<kit-dir>` doesn't exist or has no
      `.genie/manifest.json` (suggests running the MCP server first).
...
**Primary mock:** [`02-preview-refine.svg`](https://github.com/ambitresearch/genie/blob/main/docs/designs/design-6/02-preview-refine.svg) — the booted viewer + empty state.

**Supporting:** [`00-front-door.svg`](https://github.com/ambitresearch/genie/blob/main/docs/designs/design-6/00-front-door.svg).
