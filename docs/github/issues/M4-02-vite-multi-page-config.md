...
**Primary mock:** [`02-preview-refine.svg`](https://github.com/roshangautam/genie/blob/main/docs/design/02-preview-refine.svg) — each preview.html as a card entry point.
