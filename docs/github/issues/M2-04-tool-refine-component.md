---
title: "[M2-04] Tool: refine_component (with optional region rect)"
milestone: "M2 — LiteLLM Generation Surface"
labels: ["type:feature", "area:mcp-tools", "area:litellm", "priority:P1-high", "size:L"]
assignees: []
estimate: "10h"
---

## Summary
Implement `refine_component` — the iterate-on-an-existing-component verb.
...
- File: `packages/server/src/tools/refine_component.ts`.
...
**Primary mock:** [`02-preview-refine.svg`](https://github.com/roshangautam/genie/blob/main/docs/designs/design-1/02-preview-refine.svg) — the REFINE moment — sliders + region rect.
