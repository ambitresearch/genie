...
**Primary mock:** [`ref-foundations.svg`](https://github.com/ambitresearch/genie/blob/main/docs/designs/design-6/ref-foundations.svg) — palette contrast + roles via axe-core.
