...
**Primary mock:** [`02-preview-refine.svg`](https://github.com/roshangautam/genie/blob/main/docs/design/02-preview-refine.svg) — the surface everything renders into.
