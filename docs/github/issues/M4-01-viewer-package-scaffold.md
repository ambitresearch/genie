...
**Primary mock:** [`02-preview-refine.svg`](https://github.com/ambitresearch/genie/blob/main/docs/designs/design-6/02-preview-refine.svg) — the surface everything renders into.
