...
**Primary mock:** [`01-ui-kit-browser.svg`](https://github.com/ambitresearch/genie/blob/main/docs/designs/design-6/01-ui-kit-browser.svg) — the ✓ synced status the browser shows.
