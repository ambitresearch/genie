...
**Primary mock:** [`02-preview-refine.svg`](https://github.com/ambitresearch/genie/blob/main/docs/designs/design-6/02-preview-refine.svg) — a single card re-rendering in place on HMR.
