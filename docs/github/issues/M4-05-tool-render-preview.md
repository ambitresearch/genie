...
**Primary mock:** [`03-embedded-modes.svg`](https://github.com/roshangautam/genie/blob/main/docs/designs/design-1/03-embedded-modes.svg) — the inline ui:// grid payload.
