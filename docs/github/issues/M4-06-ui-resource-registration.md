...
- [ ] AC5 — CSP allow-list declared via `connectDomains` / `resourceDomains`
      / `frameDomains` per MCP-Apps spec.
...
**Primary mock:** [`03-embedded-modes.svg`](https://github.com/roshangautam/genie/blob/main/docs/design/03-embedded-modes.svg) — inline / fullscreen / pip framings.
