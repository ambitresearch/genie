...
6. **Vite-backed preview viewer** (`@ambitresearch/genie-viewer`) shipping as `npx @ambitresearch/genie-viewer <kit-path>`, with chokidar HMR, iframe grid layout, viewport buttons, `file://` fallback.
...
| D-E-18 | Harness  | Continue.dev                                                                                                                                                      | Current                                                                                                                              | OSS                      | ✅ Active                                            | Low — current schema infers transport; explicit `type` remains clearer |
...
- **Business outcome.**
  ...
  - Users can run `npx @ambitresearch/genie-viewer` and see their library at `http://localhost:5173`.
